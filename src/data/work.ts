...
export const workItems: WorkItem[] = [
  ...
  {
    slug: 'logical-decoding-archives', title: 'Logical decoding from archive-fed standbys', state: 'active',
  ...
  {
    slug: 'partial-matview-refresh', title: 'Partial materialized-view refresh', state: 'needs-review',
  ...
  {
    slug: 'wal-compression', title: 'Whole-WAL-record compression', state: 'blocked',
  ...
  {
    slug: 'multixact-standby', title: 'MultiXact standby deadlock', state: 'shipped',
    summary: 'Fix standby MultiXact creation and deadlock/corruption edge cases.',
    sessions: ['g9yl3zE9MlI', 'Szpqbb89YSA'], artifacts: [{ label: '-hackers', url: 'https://www.postgresql.org/message-id/flat/172e5723-d65f-4eec-b512-14beacb326ce%40yandex.ru' }, { label: 'CF #6070', url: 'https://commitfest.postgresql.org/patch/6070/' }],
    next: [],
  },
  {
    slug: 'command-tags', title: 'Custom protocol command tags', state: 'exploration',
  ...
  {
    slug: 'btree-page-merge', title: 'B-tree bloat removal (page merge)', state: 'active',
